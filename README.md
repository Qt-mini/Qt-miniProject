...
|  | `Car` | `public` | 생성자 | Car | const QString &carNumber, int floor, 
const QDateTime &entryTime | 저장된 주차 기록 복원 시 사용한다. 차량번호, 주차 층, 기존 입차시간을 이용해 차량 객체를 생성한다. |
